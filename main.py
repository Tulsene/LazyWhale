...
class Bot(UtilsMixin):
    ...
    def remove_orders_off_strat(self, new_open_orders):
        ...
        if orders_to_remove['sell'] or orders_to_remove['buy']:
            a = 1
    ...
    def compare_orders(self, new_open_orders):
        ...
        print('before: ',self.config.open_orders)
        self.update_open_orders(missing_orders, executed_orders)
        print('after: ',self.config.open_orders)
        print('open_orders: ', self.api.fetch_open_orders(self.config.selected_market))
    ...
    def limit_nb_orders(self):
        ...
        if nb_orders > self.config.params['nb_buy_to_display']:
            ...
            while nb_orders > 0:
                self.api.cancel_order(new_open_orders['buy'][0][0],
