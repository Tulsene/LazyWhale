...
class Lazy:
    ...
    def __init__(self):
        ...
        self.buy_price_min = Decimal('0.00147')
        self.buy_price_max = Decimal('0.00149')
        self.sell_price_min = Decimal('0.00160')
        self.sell_price_max = Decimal('0.00162')
        ...
        if new_sell_orders != []:
            ...
            if new_sell_orders != []:
                ...
                while i < target:
                    ...
                    elif new_sell_orders[i + 1][2] - new_sell_orders[i][2] < self.increment:
